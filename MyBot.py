...
def duel(game): 
    ...
    rock_weight = me.rock - op.paper if me.rock - op.paper > 0 else 0
    paper_weight = me.paper - op.scissors if me.paper - op.scissors > 0 else 0
    scissors_weight = me.scissors - op.rock if me.scissors - op.rock > 0 else 0
